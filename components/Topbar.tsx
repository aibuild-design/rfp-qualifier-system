    ...
    <header className="sticky top-0 z-20 shrink-0 border-b border-rfp-border bg-rfp-surface/95 backdrop-blur supports-backdrop-blur:bg-rfp-surface/80">
      <div className="flex h-16 items-center gap-3 px-5 lg:px-8">
        ...
        <div className="ml-auto flex items-center gap-2.5">
          ...
          <Link
            href="/dashboard/new"
            className="inline-flex min-h-11 items-center gap-1.5 rounded-lg bg-rfp-ink px-4 text-xs font-semibold text-rfp-surface press hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rfp-gold lg:hidden"
          >
