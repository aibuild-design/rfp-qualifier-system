    ...
    return (
      <section className="mt-8">
        ...
        <p className="mt-3 rounded-xl border border-dashed border-rfp-border-strong bg-rfp-surface px-5 py-4 text-sm leading-relaxed text-rfp-ink-secondary">
          Nothing to measure yet. Every time you record your own verdict on a bid, especially
          where you disagree with the desk, it is compared against what the desk said. After
          about {MIN_FOR_A_PATTERN} decisions this starts telling you where the scoring is wrong,
          and your reasons go into every future triage as worked examples.
        </p>
      </section>
    );
  }
